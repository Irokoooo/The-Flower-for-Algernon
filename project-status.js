...
const labels = {planned:'待开发',in_progress:'开发中',reworking:'调整中',blocked:'阻塞',review:'待集成 / 验收',verified:'已验证',complete:'已完成',decided:'已决定',deferred:'后续阶段',prototype:'原型素材',missing:'待制作',available:'可用',ready:'就绪'};
